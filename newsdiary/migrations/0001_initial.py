    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('POL', '정치'), ('SOC', '사회'), ('ECON', '경제')], max_length=20), default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('explanation', models.TextField(blank=True)),
                ('category', models.CharField(choices=[('POL', '정치'), ('SOC', '사회'), ('ECON', '경제')], max_length=20)),
